...
if (!class_exists('Conexao')) {
    ...
    if ($_SERVER['HTTP_HOST'] == 'localhost' || $_SERVER['HTTP_HOST'] == 'servidor') {
        ...
        DEFINE('DB_PASS', '');
        DEFINE('DB_TABLE', 'ba');
        DEFINE('SITE_URL', 'http://localhost/ba/');
        DEFINE('GERENCIE_LIB', 'http://www.agenciasingular.com.br/gerencielib/');
    } else {
        define('DB_HOST', 'mysql.agenciasingular.com.br');
        define('DB_USER', 'metavest');
        define('DB_PASS', 'meta3090*');
        define('DB_TABLE', 'metavr');
        DEFINE('SITE_URL', 'https://asingular.com.br/kasher/');
        DEFINE('GERENCIE_LIB', 'https://www.agenciasingular.com.br/gerencielib/');
    }
    ...
    DEFINE('NOME_SITE', utf8_encode('Block Academy'));
